...
function calculateCartSummary() {
    ...
    // Get discount value (remove '%' and convert to decimal)
    let discount = document.querySelector('.discount').textContent.trim().replace('%', '');
    ...
    // Calculate total (subtotal after discount plus shipping)
