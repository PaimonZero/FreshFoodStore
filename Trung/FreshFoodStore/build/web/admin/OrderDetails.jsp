                    ...
                    <div class="col-md-12">
                        <div class="card text-dark bg-light d-flex mb-3 mt-3">
                            ...
                            <div class="card-header bg-light d-flex align-items-center justify-content-between">
                                <div class="align-items-center mobile-view">
                                <h4 class="mb-0" style="font-weight: bold;">OrderDetails</h4>
                                <h5 class="mb-0" > . April 24, 2021  3 Products</h5>
                                </div>
                                <div>
                                    <button class="btn btn-sm btn-outline-secondary mb-2" style="width: 130px;">Edit</button>
                                    <button class="btn btn-sm btn-outline-success mb-2" style="width: 130px;">Back to Order List</button>
                                </div>
                            </div>
