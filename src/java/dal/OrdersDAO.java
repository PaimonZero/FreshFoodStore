...
//=================================================================================================================================================================
    ...
    public double findOrderValueById(int orderId) {
        ...
        String sql = "SELECT \n"
                ...
                + "     WHERE od.orderId = o.orderId) + o.shippingFee AS totalOrderValue\n"
                + "FROM \n"
                + "    Orders o\n"
                + "WHERE \n"
                + "    o.orderId = ?;";
        try {
            ...
            //- Trả về kết quả
            if (resultSet.next()) {
                totalOrderValue = resultSet.getDouble("totalOrderValue");
                return totalOrderValue;
            }
        } catch (SQLException e) {
            System.out.println("??(OrderDAO)findOrderValueById: " + e.getMessage());
        }
        return totalOrderValue;
    }
    ...
    public void updatePaymentStatusById(int orderId, String paymentStatus) {
        ...
        try {
            ...
            //- set parameter
            preStatement.setObject(1, paymentStatus);
            ...
            System.out.println("??(OrdersDAO)updatePaymentStatusById: " + e.getMessage());
        }
    }
